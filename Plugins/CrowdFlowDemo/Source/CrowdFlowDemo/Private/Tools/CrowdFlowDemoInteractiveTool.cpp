...
#include "CrowdFlowDemoInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UCrowdFlowDemoInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UCrowdFlowDemoInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UCrowdFlowDemoInteractiveTool* NewTool = NewObject<UCrowdFlowDemoInteractiveTool>(SceneState.ToolManager);
...
UCrowdFlowDemoInteractiveToolProperties::UCrowdFlowDemoInteractiveToolProperties()
{
...
void UCrowdFlowDemoInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UCrowdFlowDemoInteractiveTool::Setup()
{
	...
	Properties = NewObject<UCrowdFlowDemoInteractiveToolProperties>(this, "Measurement");
...
void UCrowdFlowDemoInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UCrowdFlowDemoInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UCrowdFlowDemoInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UCrowdFlowDemoInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UCrowdFlowDemoInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UCrowdFlowDemoInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UCrowdFlowDemoInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UCrowdFlowDemoInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UCrowdFlowDemoInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
