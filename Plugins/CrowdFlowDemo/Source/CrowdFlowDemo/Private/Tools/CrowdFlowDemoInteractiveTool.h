...
#include "CrowdFlowDemoInteractiveTool.generated.h"


/**
 * Builder for UCrowdFlowDemoInteractiveTool
 */
UCLASS()
class CROWDFLOWDEMO_API UCrowdFlowDemoInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UCrowdFlowDemoInteractiveTool
 */
UCLASS(Transient)
class CROWDFLOWDEMO_API UCrowdFlowDemoInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UCrowdFlowDemoInteractiveToolProperties();
...
/**
 * UCrowdFlowDemoInteractiveTool is an example Tool that allows the user to measure the 
 ...
 */
UCLASS()
class CROWDFLOWDEMO_API UCrowdFlowDemoInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UCrowdFlowDemoInteractiveToolProperties> Properties;
