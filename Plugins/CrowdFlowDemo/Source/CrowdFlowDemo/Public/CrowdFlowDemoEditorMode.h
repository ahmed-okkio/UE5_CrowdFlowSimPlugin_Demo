...
#include "CrowdFlowDemoEditorMode.generated.h"
 ...
 */
UCLASS()
class UCrowdFlowDemoEditorMode : public UEdMode
{
	GENERATED_BODY()

public:
	const static FEditorModeID EM_CrowdFlowDemoEditorModeId;

	static FString SimpleToolName;
	static FString InteractiveToolName;

	UCrowdFlowDemoEditorMode();
	virtual ~UCrowdFlowDemoEditorMode();
