...
#include "CrowdFlowInteractiveTool.generated.h"


/**
 * Builder for UCrowdFlowInteractiveTool
 */
UCLASS()
class CROWDFLOW_API UCrowdFlowInteractiveToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
 ...
 */
UCLASS(Transient)
class CROWDFLOW_API UCrowdFlowInteractiveToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UCrowdFlowInteractiveToolProperties();
 ...
 */
UCLASS()
class CROWDFLOW_API UCrowdFlowInteractiveTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
	TObjectPtr<UCrowdFlowInteractiveToolProperties> Properties;
