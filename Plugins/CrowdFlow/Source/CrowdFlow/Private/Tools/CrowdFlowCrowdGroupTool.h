...
#include "CrowdFlowCrowdGroupTool.generated.h"


/**
 * Builder for UCrowdFlowCrowdGroupTool
 */
UCLASS()
class CROWDFLOW_API UCrowdFlowCrowdGroupToolBuilder : public UInteractiveToolBuilder
{
	GENERATED_BODY()
...
/**
 * Property set for the UCrowdFlowCrowdGroupTool
 */
UCLASS(Transient)
class CROWDFLOW_API UCrowdFlowCrowdGroupToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()

public:
	UCrowdFlowCrowdGroupToolProperties();
...
/**
 * UCrowdFlowCrowdGroupTool is an example Tool that allows the user to measure the
 ...
 */
UCLASS()
class CROWDFLOW_API UCrowdFlowCrowdGroupTool : public UInteractiveTool, public IClickDragBehaviorTarget
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY()
		TObjectPtr<UCrowdFlowCrowdGroupToolProperties> Properties;
