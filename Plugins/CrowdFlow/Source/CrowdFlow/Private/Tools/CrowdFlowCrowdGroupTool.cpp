...
#include "CrowdFlowCrowdGroupTool.h"
...
#define LOCTEXT_NAMESPACE "UCrowdFlowCrowdGroupTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UCrowdFlowCrowdGroupToolBuilder::BuildTool(const FToolBuilderState& SceneState) const
{
	UCrowdFlowCrowdGroupTool* NewTool = NewObject<UCrowdFlowCrowdGroupTool>(SceneState.ToolManager);
...
UCrowdFlowCrowdGroupToolProperties::UCrowdFlowCrowdGroupToolProperties()
{
...
void UCrowdFlowCrowdGroupTool::SetWorld(UWorld* World)
{
	check(World);
...
void UCrowdFlowCrowdGroupTool::Setup()
{
	...
	Properties = NewObject<UCrowdFlowCrowdGroupToolProperties>(this, "Measurement");
...
void UCrowdFlowCrowdGroupTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UCrowdFlowCrowdGroupTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UCrowdFlowCrowdGroupTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UCrowdFlowCrowdGroupTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UCrowdFlowCrowdGroupTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UCrowdFlowCrowdGroupTool::UpdatePosition(const FRay& WorldRay)
{
...
void UCrowdFlowCrowdGroupTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UCrowdFlowCrowdGroupTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UCrowdFlowCrowdGroupTool::Render(IToolsContextRenderAPI* RenderAPI)
{
