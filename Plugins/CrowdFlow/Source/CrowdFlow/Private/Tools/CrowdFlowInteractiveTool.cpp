...
#include "CrowdFlowInteractiveTool.h"
...
#define LOCTEXT_NAMESPACE "UCrowdFlowInteractiveTool"

/*
 * ToolBuilder
 */

UInteractiveTool* UCrowdFlowInteractiveToolBuilder::BuildTool(const FToolBuilderState & SceneState) const
{
	UCrowdFlowInteractiveTool* NewTool = NewObject<UCrowdFlowInteractiveTool>(SceneState.ToolManager);
...
UCrowdFlowInteractiveToolProperties::UCrowdFlowInteractiveToolProperties()
{
...
void UCrowdFlowInteractiveTool::SetWorld(UWorld* World)
{
	check(World);
...
void UCrowdFlowInteractiveTool::Setup()
{
...
void UCrowdFlowInteractiveTool::OnUpdateModifierState(int ModifierID, bool bIsOn)
{
...
FInputRayHit UCrowdFlowInteractiveTool::CanBeginClickDragSequence(const FInputDeviceRay& PressPos)
{
...
void UCrowdFlowInteractiveTool::OnClickPress(const FInputDeviceRay& PressPos)
{
...
void UCrowdFlowInteractiveTool::OnClickDrag(const FInputDeviceRay& DragPos)
{
	UpdatePosition(DragPos.WorldRay);
}


FInputRayHit UCrowdFlowInteractiveTool::FindRayHit(const FRay& WorldRay, FVector& HitPos)
{
...
void UCrowdFlowInteractiveTool::UpdatePosition(const FRay& WorldRay)
{
...
void UCrowdFlowInteractiveTool::UpdateDistance()
{
	Properties->Distance = FVector::Distance(Properties->StartPoint, Properties->EndPoint);
}


void UCrowdFlowInteractiveTool::OnPropertyModified(UObject* PropertySet, FProperty* Property)
{
...
void UCrowdFlowInteractiveTool::Render(IToolsContextRenderAPI* RenderAPI)
{
