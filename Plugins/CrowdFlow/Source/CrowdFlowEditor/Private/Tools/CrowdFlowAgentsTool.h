 ...
 */
UCLASS(Transient)
class CROWDFLOWEDITOR_API UCrowdFlowAgentsToolProperties : public UInteractiveToolPropertySet
{
	GENERATED_BODY()
 ...
 */
UCLASS()
class CROWDFLOWEDITOR_API UCrowdFlowAgentsTool : public UInteractiveTool, public IClickBehaviorTarget
{
	GENERATED_BODY()
